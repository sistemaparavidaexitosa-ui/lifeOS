...
-- scripts/verificar-backfill-0046.sh.
...
select has_column('public', 'habits', 'routine_id', 'habits.routine_id existe (0046)');
select has_column('public', 'routines', 'identity', 'routines.identity existe (0046)');
...
-- Antes de 0046 esto lo defendían dos caminos —el paso de rutina y el hábito—

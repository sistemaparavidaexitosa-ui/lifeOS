...
| Rutinas y Hábitos | `/development/routines` | `development/routines/page.tsx`,`RoutineForm.tsx`,`HabitForm.tsx`,`HabitRow.tsx`,`RoutineTemplates.tsx`,`HabitTemplates.tsx` | `routines` (+`identity`),`habits` (+`cue`,`two_min_version`,`stack_after_habit_id`),`habit_logs`,`routine_runs`,`occupations`; catálogo en `lib/domain/development/templates.ts` | `upsertRoutine`,`deleteRoutine`,`upsertHabit`,`deleteHabit`,`toggleHabitToday`,`createRoutineFromTemplate` |

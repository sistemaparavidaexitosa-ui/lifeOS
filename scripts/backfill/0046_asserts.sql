-- scripts/backfill/0046_asserts.sql
-- Corre DESPUÉS de aplicar 0046 sobre el fixture. Cada bloque cubre un caso de
...
begin
  ...
  raise notice 'Backfill 0046: los nueve casos pasan.';
end $$;

-- scripts/backfill/0046_fixture.sql
-- Datos con la forma ANTERIOR a la migración 0046, para comprobar que el
-- backfill coloca cada hábito donde la spec dice. Lo corre
-- scripts/verificar-backfill-0046.sh, no `supabase test db`: una prueba pgTAP

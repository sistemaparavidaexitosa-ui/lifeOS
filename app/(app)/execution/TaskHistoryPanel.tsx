...
//
// Es un Server/Client-agnostic component puro (sin "use client"): recibe los
// datos ya cargados como prop y solo renderiza — se usa dentro de
// TaskDetailPanel.tsx, que sí es "use client".

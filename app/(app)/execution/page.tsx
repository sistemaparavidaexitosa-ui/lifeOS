...
// FASE 1 — único cambio funcional respecto al page.tsx original: el bloque
// de "Tareas de: {proyecto}" ahora renderiza <TaskDetailPanel> (assignees +
// deps + comentarios/menciones + historial + edición completa) en vez de un
// <div> de solo lectura. Todo lo demás (selección de proyecto vía
// ?project=, progreso, SequenceButton, formularios) se conserva igual.
    ...
    <div className="flex flex-col gap-3.5">
      ...
      <div className="grid gap-3.5" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: 14 }}>
        ...
        {(projects ?? []).map((p) => {
          ...
          return (
            <Card key={p.id} className={isSelected ? "" : ""}>

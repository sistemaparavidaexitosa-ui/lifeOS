...
export const GRAPH_VIEWS: Record<GraphViewId, GraphView> = {
  ...
  knowledge: {
    ...
    scope: "workspace",
    nodeTypes: ["workspace", "notebook", "note", "document", "meeting", "decision", "book", "project"],
  ...
  money: {
    id: "money",
    label: "Dinero",
    hint: "Cuentas, deudas, presupuesto y patrimonio",
    scope: "user",
    nodeTypes: ["account", "debt", "financial_goal", "liability",
                "investment", "budget", "asset", "goal"],

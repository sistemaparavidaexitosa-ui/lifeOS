"use server";
// Server Actions de jerarquía del tablero: reparentar tareas (arrastre para
// anidar), mover tareas entre Groups y CRUD de task_groups (migración
// 0019_execution_groups_folders.sql). Reutiliza has_project_access/
...
//
// Los cambios de ESTADO no viven aquí: pasan siempre por setTaskStatus
// (actions.ts), que aplica la máquina de estados y la validación de
// dependencias. Antes existía además updateTaskStatusFromTree(), un segundo
// camino que escribía el status SIN validar la transición; se eliminó al
// unificar las vistas para que no queden dos reglas distintas.
